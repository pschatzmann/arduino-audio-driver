...
// N1 divider options
const SrcAttr PCBCUPID_NAU8325::mclk_n1_div[] = {{1, 0x0}, {2, 0x1}, {3, 0x2}};
...
bool PCBCUPID_NAU8325::begin(uint32_t fs, uint8_t bits_per_sample,
                             uint16_t ratio) {
...
bool PCBCUPID_NAU8325::applySampleRateClocks(const SRateAttr* srate, int n1_sel,
...
int PCBCUPID_NAU8325::getMclkRatioAndN2Index(const SRateAttr* srate,
                                             int mclk_hz, int& n2_sel_out) {
...
bool PCBCUPID_NAU8325::chooseClockSource(int fs, int mclk,
                                         const SRateAttr*& srate, int& n1_sel,
...
bool PCBCUPID_NAU8325::configureAudio(uint32_t fs, uint32_t mclk,
...
bool PCBCUPID_NAU8325::setI2SFormat(AudioI2SFormat format,
...
bool PCBCUPID_NAU8325::writeRegisterBits(
